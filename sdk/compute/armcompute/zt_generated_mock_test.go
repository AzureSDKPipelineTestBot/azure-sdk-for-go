...
func TestAvailabilitySets_CreateOrUpdate(t *testing.T) {
	...
	client := NewAvailabilitySetsClient("{subscription-id}", cred, &options)
...
func TestVirtualMachineExtensions_Update(t *testing.T) {
	...
	client := NewVirtualMachineExtensionsClient("{subscription-id}", cred, &options)
...
func TestCapacityReservationGroups_CreateOrUpdate(t *testing.T) {
	...
	client := NewCapacityReservationGroupsClient("{subscription-id}", cred, &options)
	res, err := client.CreateOrUpdate(ctx,
		"myResourceGroup",
...
func TestCapacityReservationGroups_Get(t *testing.T) {
	...
	client := NewCapacityReservationGroupsClient("{subscriptionId}", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myCapacityReservationGroup",
...
func TestCapacityReservations_CreateOrUpdate(t *testing.T) {
	...
	client := NewCapacityReservationsClient("{subscription-id}", cred, &options)
	poller, err := client.BeginCreateOrUpdate(ctx,
		"myResourceGroup",
		"myCapacityReservationGroup",
...
func TestCapacityReservations_Get(t *testing.T) {
	...
	client := NewCapacityReservationsClient("{subscriptionId}", cred, &options)
	res, err := client.Get(ctx,
		"myResourceGroup",
		"myCapacityReservationGroup",
		"myCapacityReservation",
...
func TestCommunityGalleries_Get(t *testing.T) {
	...
	client := NewCommunityGalleriesClient("{subscription-id}", cred, &options)
	_, err := client.Get(ctx,
		"myLocation",
		"publicGalleryName",
		&CommunityGalleriesGetOptions{})
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestCommunityGalleryImages_Get(t *testing.T) {
	...
	client := NewCommunityGalleryImagesClient("{subscription-id}", cred, &options)
	_, err := client.Get(ctx,
		"myLocation",
		"publicGalleryName",
		"myGalleryImageName",
		&CommunityGalleryImagesGetOptions{})
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestCommunityGalleryImageVersions_Get(t *testing.T) {
	...
	client := NewCommunityGalleryImageVersionsClient("{subscription-id}", cred, &options)
	_, err := client.Get(ctx,
		"myLocation",
		"publicGalleryName",
		"myGalleryImageName",
		"myGalleryImageVersionName",
		&CommunityGalleryImageVersionsGetOptions{})
	if err != nil {
		t.Fatal(err)
	}
}
