...
func (l *ApplicationGatewayPrivateEndpointConnectionsDeletePollerResponse) Resume(ctx context.Context, client *ApplicationGatewayPrivateEndpointConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewayPrivateEndpointConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewayPrivateEndpointConnectionsDeletePoller {
...
func (l *ApplicationGatewayPrivateEndpointConnectionsUpdatePollerResponse) Resume(ctx context.Context, client *ApplicationGatewayPrivateEndpointConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewayPrivateEndpointConnectionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewayPrivateEndpointConnectionsUpdatePoller {
...
func (l *ApplicationGatewaysBackendHealthOnDemandPollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.BackendHealthOnDemand", token, 	client.pl, client.backendHealthOnDemandHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysBackendHealthOnDemandPoller {
...
func (l *ApplicationGatewaysBackendHealthPollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.BackendHealth", token, 	client.pl, client.backendHealthHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysBackendHealthPoller {
...
func (l *ApplicationGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysCreateOrUpdatePoller {
...
func (l *ApplicationGatewaysDeletePollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysDeletePoller {
...
func (l *ApplicationGatewaysStartPollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysStartPoller {
...
func (l *ApplicationGatewaysStopPollerResponse) Resume(ctx context.Context, client *ApplicationGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationGatewaysClient.Stop", token, 	client.pl, client.stopHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationGatewaysStopPoller {
...
func (l *ApplicationSecurityGroupsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ApplicationSecurityGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationSecurityGroupsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationSecurityGroupsCreateOrUpdatePoller {
...
func (l *ApplicationSecurityGroupsDeletePollerResponse) Resume(ctx context.Context, client *ApplicationSecurityGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ApplicationSecurityGroupsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ApplicationSecurityGroupsDeletePoller {
...
func (l *AzureFirewallsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *AzureFirewallsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AzureFirewallsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &AzureFirewallsCreateOrUpdatePoller {
...
func (l *AzureFirewallsDeletePollerResponse) Resume(ctx context.Context, client *AzureFirewallsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AzureFirewallsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &AzureFirewallsDeletePoller {
...
func (l *AzureFirewallsUpdateTagsPollerResponse) Resume(ctx context.Context, client *AzureFirewallsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("AzureFirewallsClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &AzureFirewallsUpdateTagsPoller {
...
func (l *BastionHostsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *BastionHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BastionHostsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &BastionHostsCreateOrUpdatePoller {
...
func (l *BastionHostsDeletePollerResponse) Resume(ctx context.Context, client *BastionHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BastionHostsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &BastionHostsDeletePoller {
...
func (l *BastionHostsUpdateTagsPollerResponse) Resume(ctx context.Context, client *BastionHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("BastionHostsClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &BastionHostsUpdateTagsPoller {
...
func (l *ConnectionMonitorsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ConnectionMonitorsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConnectionMonitorsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ConnectionMonitorsCreateOrUpdatePoller {
...
func (l *ConnectionMonitorsDeletePollerResponse) Resume(ctx context.Context, client *ConnectionMonitorsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConnectionMonitorsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ConnectionMonitorsDeletePoller {
...
func (l *ConnectionMonitorsQueryPollerResponse) Resume(ctx context.Context, client *ConnectionMonitorsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConnectionMonitorsClient.Query", token, 	client.pl, client.queryHandleError)
	if err != nil {
		return err
	}
	poller := &ConnectionMonitorsQueryPoller {
...
func (l *ConnectionMonitorsStartPollerResponse) Resume(ctx context.Context, client *ConnectionMonitorsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConnectionMonitorsClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &ConnectionMonitorsStartPoller {
...
func (l *ConnectionMonitorsStopPollerResponse) Resume(ctx context.Context, client *ConnectionMonitorsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ConnectionMonitorsClient.Stop", token, 	client.pl, client.stopHandleError)
	if err != nil {
		return err
	}
	poller := &ConnectionMonitorsStopPoller {
...
func (l *CustomIPPrefixesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *CustomIPPrefixesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CustomIPPrefixesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &CustomIPPrefixesCreateOrUpdatePoller {
...
func (l *CustomIPPrefixesDeletePollerResponse) Resume(ctx context.Context, client *CustomIPPrefixesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CustomIPPrefixesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CustomIPPrefixesDeletePoller {
...
func (l *DdosCustomPoliciesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DdosCustomPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DdosCustomPoliciesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DdosCustomPoliciesCreateOrUpdatePoller {
...
func (l *DdosCustomPoliciesDeletePollerResponse) Resume(ctx context.Context, client *DdosCustomPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DdosCustomPoliciesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DdosCustomPoliciesDeletePoller {
...
func (l *DdosProtectionPlansCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DdosProtectionPlansClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DdosProtectionPlansClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DdosProtectionPlansCreateOrUpdatePoller {
...
func (l *DdosProtectionPlansDeletePollerResponse) Resume(ctx context.Context, client *DdosProtectionPlansClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DdosProtectionPlansClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DdosProtectionPlansDeletePoller {
...
func (l *DscpConfigurationCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DscpConfigurationClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DscpConfigurationClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DscpConfigurationCreateOrUpdatePoller {
...
func (l *DscpConfigurationDeletePollerResponse) Resume(ctx context.Context, client *DscpConfigurationClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DscpConfigurationClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DscpConfigurationDeletePoller {
...
func (l *ExpressRouteCircuitAuthorizationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitAuthorizationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitAuthorizationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitAuthorizationsCreateOrUpdatePoller {
...
func (l *ExpressRouteCircuitAuthorizationsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitAuthorizationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitAuthorizationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitAuthorizationsDeletePoller {
...
func (l *ExpressRouteCircuitConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitConnectionsCreateOrUpdatePoller {
...
func (l *ExpressRouteCircuitConnectionsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitConnectionsDeletePoller {
...
func (l *ExpressRouteCircuitPeeringsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitPeeringsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitPeeringsCreateOrUpdatePoller {
...
func (l *ExpressRouteCircuitPeeringsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitPeeringsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitPeeringsDeletePoller {
...
func (l *ExpressRouteCircuitsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitsCreateOrUpdatePoller {
...
func (l *ExpressRouteCircuitsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitsDeletePoller {
...
func (l *ExpressRouteCircuitsListArpTablePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitsClient.ListArpTable", token, 	client.pl, client.listArpTableHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitsListArpTablePoller {
...
func (l *ExpressRouteCircuitsListRoutesTablePollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitsClient.ListRoutesTable", token, 	client.pl, client.listRoutesTableHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitsListRoutesTablePoller {
...
func (l *ExpressRouteCircuitsListRoutesTableSummaryPollerResponse) Resume(ctx context.Context, client *ExpressRouteCircuitsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCircuitsClient.ListRoutesTableSummary", token, 	client.pl, client.listRoutesTableSummaryHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCircuitsListRoutesTableSummaryPoller {
...
func (l *ExpressRouteConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteConnectionsCreateOrUpdatePoller {
...
func (l *ExpressRouteConnectionsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteConnectionsDeletePoller {
...
func (l *ExpressRouteCrossConnectionPeeringsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionPeeringsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionPeeringsCreateOrUpdatePoller {
...
func (l *ExpressRouteCrossConnectionPeeringsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionPeeringsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionPeeringsDeletePoller {
...
func (l *ExpressRouteCrossConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionsCreateOrUpdatePoller {
...
func (l *ExpressRouteCrossConnectionsListArpTablePollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionsClient.ListArpTable", token, 	client.pl, client.listArpTableHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionsListArpTablePoller {
...
func (l *ExpressRouteCrossConnectionsListRoutesTablePollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionsClient.ListRoutesTable", token, 	client.pl, client.listRoutesTableHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionsListRoutesTablePoller {
...
func (l *ExpressRouteCrossConnectionsListRoutesTableSummaryPollerResponse) Resume(ctx context.Context, client *ExpressRouteCrossConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteCrossConnectionsClient.ListRoutesTableSummary", token, 	client.pl, client.listRoutesTableSummaryHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteCrossConnectionsListRoutesTableSummaryPoller {
...
func (l *ExpressRouteGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRouteGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteGatewaysCreateOrUpdatePoller {
...
func (l *ExpressRouteGatewaysDeletePollerResponse) Resume(ctx context.Context, client *ExpressRouteGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteGatewaysDeletePoller {
...
func (l *ExpressRouteGatewaysUpdateTagsPollerResponse) Resume(ctx context.Context, client *ExpressRouteGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRouteGatewaysClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRouteGatewaysUpdateTagsPoller {
...
func (l *ExpressRoutePortsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ExpressRoutePortsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRoutePortsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRoutePortsCreateOrUpdatePoller {
...
func (l *ExpressRoutePortsDeletePollerResponse) Resume(ctx context.Context, client *ExpressRoutePortsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ExpressRoutePortsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ExpressRoutePortsDeletePoller {
...
func (l *FirewallPoliciesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *FirewallPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FirewallPoliciesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &FirewallPoliciesCreateOrUpdatePoller {
...
func (l *FirewallPoliciesDeletePollerResponse) Resume(ctx context.Context, client *FirewallPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FirewallPoliciesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &FirewallPoliciesDeletePoller {
...
func (l *FirewallPolicyRuleCollectionGroupsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *FirewallPolicyRuleCollectionGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FirewallPolicyRuleCollectionGroupsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &FirewallPolicyRuleCollectionGroupsCreateOrUpdatePoller {
...
func (l *FirewallPolicyRuleCollectionGroupsDeletePollerResponse) Resume(ctx context.Context, client *FirewallPolicyRuleCollectionGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FirewallPolicyRuleCollectionGroupsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &FirewallPolicyRuleCollectionGroupsDeletePoller {
...
func (l *FlowLogsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *FlowLogsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FlowLogsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &FlowLogsCreateOrUpdatePoller {
...
func (l *FlowLogsDeletePollerResponse) Resume(ctx context.Context, client *FlowLogsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("FlowLogsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &FlowLogsDeletePoller {
...
func (l *HubRouteTablesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *HubRouteTablesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("HubRouteTablesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &HubRouteTablesCreateOrUpdatePoller {
...
func (l *HubRouteTablesDeletePollerResponse) Resume(ctx context.Context, client *HubRouteTablesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("HubRouteTablesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &HubRouteTablesDeletePoller {
...
func (l *HubVirtualNetworkConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *HubVirtualNetworkConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("HubVirtualNetworkConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &HubVirtualNetworkConnectionsCreateOrUpdatePoller {
...
func (l *HubVirtualNetworkConnectionsDeletePollerResponse) Resume(ctx context.Context, client *HubVirtualNetworkConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("HubVirtualNetworkConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &HubVirtualNetworkConnectionsDeletePoller {
...
func (l *IPAllocationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *IPAllocationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("IPAllocationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &IPAllocationsCreateOrUpdatePoller {
...
func (l *IPAllocationsDeletePollerResponse) Resume(ctx context.Context, client *IPAllocationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("IPAllocationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &IPAllocationsDeletePoller {
...
func (l *IPGroupsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *IPGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("IPGroupsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &IPGroupsCreateOrUpdatePoller {
...
func (l *IPGroupsDeletePollerResponse) Resume(ctx context.Context, client *IPGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("IPGroupsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &IPGroupsDeletePoller {
...
func (l *InboundNatRulesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *InboundNatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("InboundNatRulesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &InboundNatRulesCreateOrUpdatePoller {
...
func (l *InboundNatRulesDeletePollerResponse) Resume(ctx context.Context, client *InboundNatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("InboundNatRulesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &InboundNatRulesDeletePoller {
...
func (l *InboundSecurityRuleCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *InboundSecurityRuleClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("InboundSecurityRuleClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &InboundSecurityRuleCreateOrUpdatePoller {
...
func (l *LoadBalancerBackendAddressPoolsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *LoadBalancerBackendAddressPoolsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancerBackendAddressPoolsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancerBackendAddressPoolsCreateOrUpdatePoller {
...
func (l *LoadBalancerBackendAddressPoolsDeletePollerResponse) Resume(ctx context.Context, client *LoadBalancerBackendAddressPoolsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancerBackendAddressPoolsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancerBackendAddressPoolsDeletePoller {
...
func (l *LoadBalancersCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *LoadBalancersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancersClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancersCreateOrUpdatePoller {
...
func (l *LoadBalancersDeletePollerResponse) Resume(ctx context.Context, client *LoadBalancersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancersClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancersDeletePoller {
...
func (l *LoadBalancersListInboundNatRulePortMappingsPollerResponse) Resume(ctx context.Context, client *LoadBalancersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancersClient.ListInboundNatRulePortMappings", token, 	client.pl, client.listInboundNatRulePortMappingsHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancersListInboundNatRulePortMappingsPoller {
...
func (l *LoadBalancersSwapPublicIPAddressesPollerResponse) Resume(ctx context.Context, client *LoadBalancersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LoadBalancersClient.SwapPublicIPAddresses", token, 	client.pl, client.swapPublicIPAddressesHandleError)
	if err != nil {
		return err
	}
	poller := &LoadBalancersSwapPublicIPAddressesPoller {
...
func (l *LocalNetworkGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *LocalNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LocalNetworkGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &LocalNetworkGatewaysCreateOrUpdatePoller {
...
func (l *LocalNetworkGatewaysDeletePollerResponse) Resume(ctx context.Context, client *LocalNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LocalNetworkGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &LocalNetworkGatewaysDeletePoller {
...
func (l *NatGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NatGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NatGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NatGatewaysCreateOrUpdatePoller {
...
func (l *NatGatewaysDeletePollerResponse) Resume(ctx context.Context, client *NatGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NatGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NatGatewaysDeletePoller {
...
func (l *NatRulesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NatRulesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NatRulesCreateOrUpdatePoller {
...
func (l *NatRulesDeletePollerResponse) Resume(ctx context.Context, client *NatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NatRulesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NatRulesDeletePoller {
...
func (l *NetworkInterfaceTapConfigurationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NetworkInterfaceTapConfigurationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfaceTapConfigurationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfaceTapConfigurationsCreateOrUpdatePoller {
...
func (l *NetworkInterfaceTapConfigurationsDeletePollerResponse) Resume(ctx context.Context, client *NetworkInterfaceTapConfigurationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfaceTapConfigurationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfaceTapConfigurationsDeletePoller {
...
func (l *NetworkInterfacesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NetworkInterfacesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfacesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfacesCreateOrUpdatePoller {
...
func (l *NetworkInterfacesDeletePollerResponse) Resume(ctx context.Context, client *NetworkInterfacesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfacesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfacesDeletePoller {
...
func (l *NetworkInterfacesGetEffectiveRouteTablePollerResponse) Resume(ctx context.Context, client *NetworkInterfacesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfacesClient.GetEffectiveRouteTable", token, 	client.pl, client.getEffectiveRouteTableHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfacesGetEffectiveRouteTablePoller {
...
func (l *NetworkInterfacesListEffectiveNetworkSecurityGroupsPollerResponse) Resume(ctx context.Context, client *NetworkInterfacesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkInterfacesClient.ListEffectiveNetworkSecurityGroups", token, 	client.pl, client.listEffectiveNetworkSecurityGroupsHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkInterfacesListEffectiveNetworkSecurityGroupsPoller {
...
func (l *NetworkManagementClientDeleteBastionShareableLinkPollerResponse) Resume(ctx context.Context, client *NetworkManagementClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkManagementClient.DeleteBastionShareableLink", token, 	client.pl, client.deleteBastionShareableLinkHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkManagementClientDeleteBastionShareableLinkPoller {
...
func (l *NetworkManagementClientGeneratevirtualwanvpnserverconfigurationvpnprofilePollerResponse) Resume(ctx context.Context, client *NetworkManagementClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkManagementClient.Generatevirtualwanvpnserverconfigurationvpnprofile", token, 	client.pl, client.generatevirtualwanvpnserverconfigurationvpnprofileHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkManagementClientGeneratevirtualwanvpnserverconfigurationvpnprofilePoller {
...
func (l *NetworkManagementClientGetActiveSessionsPollerResponse) Resume(ctx context.Context, client *NetworkManagementClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkManagementClient.GetActiveSessions", token, 	client.pl, client.getActiveSessionsHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkManagementClientGetActiveSessionsPoller {
...
func (l *NetworkManagementClientPutBastionShareableLinkPollerResponse) Resume(ctx context.Context, client *NetworkManagementClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkManagementClient.PutBastionShareableLink", token, 	client.pl, client.putBastionShareableLinkHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkManagementClientPutBastionShareableLinkPoller {
...
func (l *NetworkProfilesDeletePollerResponse) Resume(ctx context.Context, client *NetworkProfilesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkProfilesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkProfilesDeletePoller {
...
func (l *NetworkSecurityGroupsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NetworkSecurityGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkSecurityGroupsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkSecurityGroupsCreateOrUpdatePoller {
...
func (l *NetworkSecurityGroupsDeletePollerResponse) Resume(ctx context.Context, client *NetworkSecurityGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkSecurityGroupsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkSecurityGroupsDeletePoller {
...
func (l *NetworkVirtualAppliancesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *NetworkVirtualAppliancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkVirtualAppliancesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkVirtualAppliancesCreateOrUpdatePoller {
...
func (l *NetworkVirtualAppliancesDeletePollerResponse) Resume(ctx context.Context, client *NetworkVirtualAppliancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkVirtualAppliancesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkVirtualAppliancesDeletePoller {
...
func (l *NetworkWatchersCheckConnectivityPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.CheckConnectivity", token, 	client.pl, client.checkConnectivityHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersCheckConnectivityPoller {
...
func (l *NetworkWatchersDeletePollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersDeletePoller {
...
func (l *NetworkWatchersGetAzureReachabilityReportPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetAzureReachabilityReport", token, 	client.pl, client.getAzureReachabilityReportHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetAzureReachabilityReportPoller {
...
func (l *NetworkWatchersGetFlowLogStatusPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetFlowLogStatus", token, 	client.pl, client.getFlowLogStatusHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetFlowLogStatusPoller {
...
func (l *NetworkWatchersGetNetworkConfigurationDiagnosticPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetNetworkConfigurationDiagnostic", token, 	client.pl, client.getNetworkConfigurationDiagnosticHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetNetworkConfigurationDiagnosticPoller {
...
func (l *NetworkWatchersGetNextHopPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetNextHop", token, 	client.pl, client.getNextHopHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetNextHopPoller {
...
func (l *NetworkWatchersGetTroubleshootingPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetTroubleshooting", token, 	client.pl, client.getTroubleshootingHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetTroubleshootingPoller {
...
func (l *NetworkWatchersGetTroubleshootingResultPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetTroubleshootingResult", token, 	client.pl, client.getTroubleshootingResultHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetTroubleshootingResultPoller {
...
func (l *NetworkWatchersGetVMSecurityRulesPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.GetVMSecurityRules", token, 	client.pl, client.getVMSecurityRulesHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersGetVMSecurityRulesPoller {
...
func (l *NetworkWatchersListAvailableProvidersPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.ListAvailableProviders", token, 	client.pl, client.listAvailableProvidersHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersListAvailableProvidersPoller {
...
func (l *NetworkWatchersSetFlowLogConfigurationPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.SetFlowLogConfiguration", token, 	client.pl, client.setFlowLogConfigurationHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersSetFlowLogConfigurationPoller {
...
func (l *NetworkWatchersVerifyIPFlowPollerResponse) Resume(ctx context.Context, client *NetworkWatchersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("NetworkWatchersClient.VerifyIPFlow", token, 	client.pl, client.verifyIPFlowHandleError)
	if err != nil {
		return err
	}
	poller := &NetworkWatchersVerifyIPFlowPoller {
...
func (l *P2SVPNGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysCreateOrUpdatePoller {
...
func (l *P2SVPNGatewaysDeletePollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysDeletePoller {
...
func (l *P2SVPNGatewaysDisconnectP2SVPNConnectionsPollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.DisconnectP2SVPNConnections", token, 	client.pl, client.disconnectP2SVPNConnectionsHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysDisconnectP2SVPNConnectionsPoller {
...
func (l *P2SVPNGatewaysGenerateVPNProfilePollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.GenerateVPNProfile", token, 	client.pl, client.generateVPNProfileHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysGenerateVPNProfilePoller {
...
func (l *P2SVPNGatewaysGetP2SVPNConnectionHealthDetailedPollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.GetP2SVPNConnectionHealthDetailed", token, 	client.pl, client.getP2SVPNConnectionHealthDetailedHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysGetP2SVPNConnectionHealthDetailedPoller {
...
func (l *P2SVPNGatewaysGetP2SVPNConnectionHealthPollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.GetP2SVPNConnectionHealth", token, 	client.pl, client.getP2SVPNConnectionHealthHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysGetP2SVPNConnectionHealthPoller {
...
func (l *P2SVPNGatewaysResetPollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.Reset", token, 	client.pl, client.resetHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysResetPoller {
...
func (l *P2SVPNGatewaysUpdateTagsPollerResponse) Resume(ctx context.Context, client *P2SVPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("P2SVPNGatewaysClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &P2SVPNGatewaysUpdateTagsPoller {
...
func (l *PacketCapturesCreatePollerResponse) Resume(ctx context.Context, client *PacketCapturesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PacketCapturesClient.Create", token, 	client.pl, client.createHandleError)
	if err != nil {
		return err
	}
	poller := &PacketCapturesCreatePoller {
...
func (l *PacketCapturesDeletePollerResponse) Resume(ctx context.Context, client *PacketCapturesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PacketCapturesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PacketCapturesDeletePoller {
...
func (l *PacketCapturesGetStatusPollerResponse) Resume(ctx context.Context, client *PacketCapturesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PacketCapturesClient.GetStatus", token, 	client.pl, client.getStatusHandleError)
	if err != nil {
		return err
	}
	poller := &PacketCapturesGetStatusPoller {
...
func (l *PacketCapturesStopPollerResponse) Resume(ctx context.Context, client *PacketCapturesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PacketCapturesClient.Stop", token, 	client.pl, client.stopHandleError)
	if err != nil {
		return err
	}
	poller := &PacketCapturesStopPoller {
...
func (l *PrivateDNSZoneGroupsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PrivateDNSZoneGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateDNSZoneGroupsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateDNSZoneGroupsCreateOrUpdatePoller {
...
func (l *PrivateDNSZoneGroupsDeletePollerResponse) Resume(ctx context.Context, client *PrivateDNSZoneGroupsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateDNSZoneGroupsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateDNSZoneGroupsDeletePoller {
...
func (l *PrivateEndpointsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PrivateEndpointsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateEndpointsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateEndpointsCreateOrUpdatePoller {
...
func (l *PrivateEndpointsDeletePollerResponse) Resume(ctx context.Context, client *PrivateEndpointsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateEndpointsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateEndpointsDeletePoller {
...
func (l *PrivateLinkServicesCheckPrivateLinkServiceVisibilityByResourceGroupPollerResponse) Resume(ctx context.Context, client *PrivateLinkServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateLinkServicesClient.CheckPrivateLinkServiceVisibilityByResourceGroup", token, 	client.pl, client.checkPrivateLinkServiceVisibilityByResourceGroupHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateLinkServicesCheckPrivateLinkServiceVisibilityByResourceGroupPoller {
...
func (l *PrivateLinkServicesCheckPrivateLinkServiceVisibilityPollerResponse) Resume(ctx context.Context, client *PrivateLinkServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateLinkServicesClient.CheckPrivateLinkServiceVisibility", token, 	client.pl, client.checkPrivateLinkServiceVisibilityHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateLinkServicesCheckPrivateLinkServiceVisibilityPoller {
...
func (l *PrivateLinkServicesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PrivateLinkServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateLinkServicesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateLinkServicesCreateOrUpdatePoller {
...
func (l *PrivateLinkServicesDeletePollerResponse) Resume(ctx context.Context, client *PrivateLinkServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateLinkServicesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateLinkServicesDeletePoller {
...
func (l *PrivateLinkServicesDeletePrivateEndpointConnectionPollerResponse) Resume(ctx context.Context, client *PrivateLinkServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PrivateLinkServicesClient.DeletePrivateEndpointConnection", token, 	client.pl, client.deletePrivateEndpointConnectionHandleError)
	if err != nil {
		return err
	}
	poller := &PrivateLinkServicesDeletePrivateEndpointConnectionPoller {
...
func (l *PublicIPAddressesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PublicIPAddressesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PublicIPAddressesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PublicIPAddressesCreateOrUpdatePoller {
...
func (l *PublicIPAddressesDeletePollerResponse) Resume(ctx context.Context, client *PublicIPAddressesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PublicIPAddressesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PublicIPAddressesDeletePoller {
...
func (l *PublicIPPrefixesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *PublicIPPrefixesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PublicIPPrefixesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &PublicIPPrefixesCreateOrUpdatePoller {
...
func (l *PublicIPPrefixesDeletePollerResponse) Resume(ctx context.Context, client *PublicIPPrefixesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("PublicIPPrefixesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &PublicIPPrefixesDeletePoller {
...
func (l *RouteFilterRulesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *RouteFilterRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteFilterRulesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &RouteFilterRulesCreateOrUpdatePoller {
...
func (l *RouteFilterRulesDeletePollerResponse) Resume(ctx context.Context, client *RouteFilterRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteFilterRulesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RouteFilterRulesDeletePoller {
...
func (l *RouteFiltersCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *RouteFiltersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteFiltersClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &RouteFiltersCreateOrUpdatePoller {
...
func (l *RouteFiltersDeletePollerResponse) Resume(ctx context.Context, client *RouteFiltersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteFiltersClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RouteFiltersDeletePoller {
...
func (l *RouteTablesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *RouteTablesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteTablesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &RouteTablesCreateOrUpdatePoller {
...
func (l *RouteTablesDeletePollerResponse) Resume(ctx context.Context, client *RouteTablesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RouteTablesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RouteTablesDeletePoller {
...
func (l *RoutesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *RoutesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RoutesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &RoutesCreateOrUpdatePoller {
...
func (l *RoutesDeletePollerResponse) Resume(ctx context.Context, client *RoutesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RoutesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RoutesDeletePoller {
...
func (l *RoutingIntentCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *RoutingIntentClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RoutingIntentClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &RoutingIntentCreateOrUpdatePoller {
...
func (l *RoutingIntentDeletePollerResponse) Resume(ctx context.Context, client *RoutingIntentClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RoutingIntentClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RoutingIntentDeletePoller {
...
func (l *SecurityPartnerProvidersCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *SecurityPartnerProvidersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SecurityPartnerProvidersClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &SecurityPartnerProvidersCreateOrUpdatePoller {
...
func (l *SecurityPartnerProvidersDeletePollerResponse) Resume(ctx context.Context, client *SecurityPartnerProvidersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SecurityPartnerProvidersClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &SecurityPartnerProvidersDeletePoller {
...
func (l *SecurityRulesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *SecurityRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SecurityRulesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &SecurityRulesCreateOrUpdatePoller {
...
func (l *SecurityRulesDeletePollerResponse) Resume(ctx context.Context, client *SecurityRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SecurityRulesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &SecurityRulesDeletePoller {
...
func (l *ServiceEndpointPoliciesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ServiceEndpointPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServiceEndpointPoliciesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ServiceEndpointPoliciesCreateOrUpdatePoller {
...
func (l *ServiceEndpointPoliciesDeletePollerResponse) Resume(ctx context.Context, client *ServiceEndpointPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServiceEndpointPoliciesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ServiceEndpointPoliciesDeletePoller {
...
func (l *ServiceEndpointPolicyDefinitionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ServiceEndpointPolicyDefinitionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServiceEndpointPolicyDefinitionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ServiceEndpointPolicyDefinitionsCreateOrUpdatePoller {
...
func (l *ServiceEndpointPolicyDefinitionsDeletePollerResponse) Resume(ctx context.Context, client *ServiceEndpointPolicyDefinitionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ServiceEndpointPolicyDefinitionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ServiceEndpointPolicyDefinitionsDeletePoller {
...
func (l *SubnetsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *SubnetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SubnetsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &SubnetsCreateOrUpdatePoller {
...
func (l *SubnetsDeletePollerResponse) Resume(ctx context.Context, client *SubnetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SubnetsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &SubnetsDeletePoller {
...
func (l *SubnetsPrepareNetworkPoliciesPollerResponse) Resume(ctx context.Context, client *SubnetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SubnetsClient.PrepareNetworkPolicies", token, 	client.pl, client.prepareNetworkPoliciesHandleError)
	if err != nil {
		return err
	}
	poller := &SubnetsPrepareNetworkPoliciesPoller {
...
func (l *SubnetsUnprepareNetworkPoliciesPollerResponse) Resume(ctx context.Context, client *SubnetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SubnetsClient.UnprepareNetworkPolicies", token, 	client.pl, client.unprepareNetworkPoliciesHandleError)
	if err != nil {
		return err
	}
	poller := &SubnetsUnprepareNetworkPoliciesPoller {
...
func (l *VPNConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VPNConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VPNConnectionsCreateOrUpdatePoller {
...
func (l *VPNConnectionsDeletePollerResponse) Resume(ctx context.Context, client *VPNConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VPNConnectionsDeletePoller {
...
func (l *VPNConnectionsStartPacketCapturePollerResponse) Resume(ctx context.Context, client *VPNConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNConnectionsClient.StartPacketCapture", token, 	client.pl, client.startPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VPNConnectionsStartPacketCapturePoller {
...
func (l *VPNConnectionsStopPacketCapturePollerResponse) Resume(ctx context.Context, client *VPNConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNConnectionsClient.StopPacketCapture", token, 	client.pl, client.stopPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VPNConnectionsStopPacketCapturePoller {
...
func (l *VPNGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysCreateOrUpdatePoller {
...
func (l *VPNGatewaysDeletePollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysDeletePoller {
...
func (l *VPNGatewaysResetPollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.Reset", token, 	client.pl, client.resetHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysResetPoller {
...
func (l *VPNGatewaysStartPacketCapturePollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.StartPacketCapture", token, 	client.pl, client.startPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysStartPacketCapturePoller {
...
func (l *VPNGatewaysStopPacketCapturePollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.StopPacketCapture", token, 	client.pl, client.stopPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysStopPacketCapturePoller {
...
func (l *VPNGatewaysUpdateTagsPollerResponse) Resume(ctx context.Context, client *VPNGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNGatewaysClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &VPNGatewaysUpdateTagsPoller {
...
func (l *VPNLinkConnectionsGetIkeSasPollerResponse) Resume(ctx context.Context, client *VPNLinkConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNLinkConnectionsClient.GetIkeSas", token, 	client.pl, client.getIkeSasHandleError)
	if err != nil {
		return err
	}
	poller := &VPNLinkConnectionsGetIkeSasPoller {
...
func (l *VPNLinkConnectionsResetConnectionPollerResponse) Resume(ctx context.Context, client *VPNLinkConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNLinkConnectionsClient.ResetConnection", token, 	client.pl, client.resetConnectionHandleError)
	if err != nil {
		return err
	}
	poller := &VPNLinkConnectionsResetConnectionPoller {
...
func (l *VPNServerConfigurationsAssociatedWithVirtualWanListPollerResponse) Resume(ctx context.Context, client *VPNServerConfigurationsAssociatedWithVirtualWanClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNServerConfigurationsAssociatedWithVirtualWanClient.List", token, 	client.pl, client.listHandleError)
	if err != nil {
		return err
	}
	poller := &VPNServerConfigurationsAssociatedWithVirtualWanListPoller {
...
func (l *VPNServerConfigurationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VPNServerConfigurationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNServerConfigurationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VPNServerConfigurationsCreateOrUpdatePoller {
...
func (l *VPNServerConfigurationsDeletePollerResponse) Resume(ctx context.Context, client *VPNServerConfigurationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNServerConfigurationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VPNServerConfigurationsDeletePoller {
...
func (l *VPNSitesConfigurationDownloadPollerResponse) Resume(ctx context.Context, client *VPNSitesConfigurationClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNSitesConfigurationClient.Download", token, 	client.pl, client.downloadHandleError)
	if err != nil {
		return err
	}
	poller := &VPNSitesConfigurationDownloadPoller {
...
func (l *VPNSitesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VPNSitesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNSitesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VPNSitesCreateOrUpdatePoller {
...
func (l *VPNSitesDeletePollerResponse) Resume(ctx context.Context, client *VPNSitesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VPNSitesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VPNSitesDeletePoller {
...
func (l *VirtualApplianceSitesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualApplianceSitesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualApplianceSitesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualApplianceSitesCreateOrUpdatePoller {
...
func (l *VirtualApplianceSitesDeletePollerResponse) Resume(ctx context.Context, client *VirtualApplianceSitesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualApplianceSitesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualApplianceSitesDeletePoller {
...
func (l *VirtualHubBgpConnectionCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualHubBgpConnectionClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubBgpConnectionClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubBgpConnectionCreateOrUpdatePoller {
...
func (l *VirtualHubBgpConnectionDeletePollerResponse) Resume(ctx context.Context, client *VirtualHubBgpConnectionClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubBgpConnectionClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubBgpConnectionDeletePoller {
...
func (l *VirtualHubBgpConnectionsListAdvertisedRoutesPollerResponse) Resume(ctx context.Context, client *VirtualHubBgpConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubBgpConnectionsClient.ListAdvertisedRoutes", token, 	client.pl, client.listAdvertisedRoutesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubBgpConnectionsListAdvertisedRoutesPoller {
...
func (l *VirtualHubBgpConnectionsListLearnedRoutesPollerResponse) Resume(ctx context.Context, client *VirtualHubBgpConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubBgpConnectionsClient.ListLearnedRoutes", token, 	client.pl, client.listLearnedRoutesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubBgpConnectionsListLearnedRoutesPoller {
...
func (l *VirtualHubIPConfigurationCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualHubIPConfigurationClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubIPConfigurationClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubIPConfigurationCreateOrUpdatePoller {
...
func (l *VirtualHubIPConfigurationDeletePollerResponse) Resume(ctx context.Context, client *VirtualHubIPConfigurationClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubIPConfigurationClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubIPConfigurationDeletePoller {
...
func (l *VirtualHubRouteTableV2SCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualHubRouteTableV2SClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubRouteTableV2SClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubRouteTableV2SCreateOrUpdatePoller {
...
func (l *VirtualHubRouteTableV2SDeletePollerResponse) Resume(ctx context.Context, client *VirtualHubRouteTableV2SClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubRouteTableV2SClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubRouteTableV2SDeletePoller {
...
func (l *VirtualHubsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualHubsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubsCreateOrUpdatePoller {
...
func (l *VirtualHubsDeletePollerResponse) Resume(ctx context.Context, client *VirtualHubsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubsDeletePoller {
...
func (l *VirtualHubsGetEffectiveVirtualHubRoutesPollerResponse) Resume(ctx context.Context, client *VirtualHubsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualHubsClient.GetEffectiveVirtualHubRoutes", token, 	client.pl, client.getEffectiveVirtualHubRoutesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualHubsGetEffectiveVirtualHubRoutesPoller {
...
func (l *VirtualNetworkGatewayConnectionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsCreateOrUpdatePoller {
...
func (l *VirtualNetworkGatewayConnectionsDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsDeletePoller {
...
func (l *VirtualNetworkGatewayConnectionsGetIkeSasPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.GetIkeSas", token, 	client.pl, client.getIkeSasHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsGetIkeSasPoller {
...
func (l *VirtualNetworkGatewayConnectionsResetConnectionPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.ResetConnection", token, 	client.pl, client.resetConnectionHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsResetConnectionPoller {
...
func (l *VirtualNetworkGatewayConnectionsResetSharedKeyPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.ResetSharedKey", token, 	client.pl, client.resetSharedKeyHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsResetSharedKeyPoller {
...
func (l *VirtualNetworkGatewayConnectionsSetSharedKeyPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.SetSharedKey", token, 	client.pl, client.setSharedKeyHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsSetSharedKeyPoller {
...
func (l *VirtualNetworkGatewayConnectionsStartPacketCapturePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.StartPacketCapture", token, 	client.pl, client.startPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsStartPacketCapturePoller {
...
func (l *VirtualNetworkGatewayConnectionsStopPacketCapturePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.StopPacketCapture", token, 	client.pl, client.stopPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsStopPacketCapturePoller {
...
func (l *VirtualNetworkGatewayConnectionsUpdateTagsPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayConnectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayConnectionsClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayConnectionsUpdateTagsPoller {
...
func (l *VirtualNetworkGatewayNatRulesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayNatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayNatRulesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayNatRulesCreateOrUpdatePoller {
...
func (l *VirtualNetworkGatewayNatRulesDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewayNatRulesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewayNatRulesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewayNatRulesDeletePoller {
...
func (l *VirtualNetworkGatewaysCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysCreateOrUpdatePoller {
...
func (l *VirtualNetworkGatewaysDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysDeletePoller {
...
func (l *VirtualNetworkGatewaysDisconnectVirtualNetworkGatewayVPNConnectionsPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.DisconnectVirtualNetworkGatewayVPNConnections", token, 	client.pl, client.disconnectVirtualNetworkGatewayVPNConnectionsHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysDisconnectVirtualNetworkGatewayVPNConnectionsPoller {
...
func (l *VirtualNetworkGatewaysGenerateVPNProfilePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GenerateVPNProfile", token, 	client.pl, client.generateVPNProfileHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGenerateVPNProfilePoller {
...
func (l *VirtualNetworkGatewaysGeneratevpnclientpackagePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.Generatevpnclientpackage", token, 	client.pl, client.generatevpnclientpackageHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGeneratevpnclientpackagePoller {
...
func (l *VirtualNetworkGatewaysGetAdvertisedRoutesPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GetAdvertisedRoutes", token, 	client.pl, client.getAdvertisedRoutesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGetAdvertisedRoutesPoller {
...
func (l *VirtualNetworkGatewaysGetBgpPeerStatusPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GetBgpPeerStatus", token, 	client.pl, client.getBgpPeerStatusHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGetBgpPeerStatusPoller {
...
func (l *VirtualNetworkGatewaysGetLearnedRoutesPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GetLearnedRoutes", token, 	client.pl, client.getLearnedRoutesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGetLearnedRoutesPoller {
...
func (l *VirtualNetworkGatewaysGetVPNProfilePackageURLPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GetVPNProfilePackageURL", token, 	client.pl, client.getVPNProfilePackageURLHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGetVPNProfilePackageURLPoller {
...
func (l *VirtualNetworkGatewaysGetVpnclientIPSecParametersPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.GetVpnclientIPSecParameters", token, 	client.pl, client.getVpnclientIPSecParametersHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysGetVpnclientIPSecParametersPoller {
...
func (l *VirtualNetworkGatewaysResetPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.Reset", token, 	client.pl, client.resetHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysResetPoller {
...
func (l *VirtualNetworkGatewaysResetVPNClientSharedKeyPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.ResetVPNClientSharedKey", token, 	client.pl, client.resetVPNClientSharedKeyHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysResetVPNClientSharedKeyPoller {
...
func (l *VirtualNetworkGatewaysSetVpnclientIPSecParametersPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.SetVpnclientIPSecParameters", token, 	client.pl, client.setVpnclientIPSecParametersHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysSetVpnclientIPSecParametersPoller {
...
func (l *VirtualNetworkGatewaysStartPacketCapturePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.StartPacketCapture", token, 	client.pl, client.startPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysStartPacketCapturePoller {
...
func (l *VirtualNetworkGatewaysStopPacketCapturePollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.StopPacketCapture", token, 	client.pl, client.stopPacketCaptureHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysStopPacketCapturePoller {
...
func (l *VirtualNetworkGatewaysUpdateTagsPollerResponse) Resume(ctx context.Context, client *VirtualNetworkGatewaysClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkGatewaysClient.UpdateTags", token, 	client.pl, client.updateTagsHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkGatewaysUpdateTagsPoller {
...
func (l *VirtualNetworkPeeringsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworkPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkPeeringsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkPeeringsCreateOrUpdatePoller {
...
func (l *VirtualNetworkPeeringsDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworkPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkPeeringsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkPeeringsDeletePoller {
...
func (l *VirtualNetworkTapsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworkTapsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkTapsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkTapsCreateOrUpdatePoller {
...
func (l *VirtualNetworkTapsDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworkTapsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworkTapsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworkTapsDeletePoller {
...
func (l *VirtualNetworksCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualNetworksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworksClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworksCreateOrUpdatePoller {
...
func (l *VirtualNetworksDeletePollerResponse) Resume(ctx context.Context, client *VirtualNetworksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualNetworksClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualNetworksDeletePoller {
...
func (l *VirtualRouterPeeringsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualRouterPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualRouterPeeringsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualRouterPeeringsCreateOrUpdatePoller {
...
func (l *VirtualRouterPeeringsDeletePollerResponse) Resume(ctx context.Context, client *VirtualRouterPeeringsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualRouterPeeringsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualRouterPeeringsDeletePoller {
...
func (l *VirtualRoutersCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualRoutersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualRoutersClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualRoutersCreateOrUpdatePoller {
...
func (l *VirtualRoutersDeletePollerResponse) Resume(ctx context.Context, client *VirtualRoutersClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualRoutersClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualRoutersDeletePoller {
...
func (l *VirtualWansCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualWansClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualWansClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualWansCreateOrUpdatePoller {
...
func (l *VirtualWansDeletePollerResponse) Resume(ctx context.Context, client *VirtualWansClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualWansClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualWansDeletePoller {
...
func (l *WebApplicationFirewallPoliciesDeletePollerResponse) Resume(ctx context.Context, client *WebApplicationFirewallPoliciesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("WebApplicationFirewallPoliciesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &WebApplicationFirewallPoliciesDeletePoller {
