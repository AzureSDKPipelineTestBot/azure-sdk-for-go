...
func (l *CapacityReservationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *CapacityReservationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CapacityReservationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &CapacityReservationsCreateOrUpdatePoller {
...
func (l *CapacityReservationsDeletePollerResponse) Resume(ctx context.Context, client *CapacityReservationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CapacityReservationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CapacityReservationsDeletePoller {
...
func (l *CapacityReservationsUpdatePollerResponse) Resume(ctx context.Context, client *CapacityReservationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CapacityReservationsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &CapacityReservationsUpdatePoller {
...
func (l *CloudServiceRoleInstancesDeletePollerResponse) Resume(ctx context.Context, client *CloudServiceRoleInstancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServiceRoleInstancesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServiceRoleInstancesDeletePoller {
...
func (l *CloudServiceRoleInstancesRebuildPollerResponse) Resume(ctx context.Context, client *CloudServiceRoleInstancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServiceRoleInstancesClient.Rebuild", token, 	client.pl, client.rebuildHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServiceRoleInstancesRebuildPoller {
...
func (l *CloudServiceRoleInstancesReimagePollerResponse) Resume(ctx context.Context, client *CloudServiceRoleInstancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServiceRoleInstancesClient.Reimage", token, 	client.pl, client.reimageHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServiceRoleInstancesReimagePoller {
...
func (l *CloudServiceRoleInstancesRestartPollerResponse) Resume(ctx context.Context, client *CloudServiceRoleInstancesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServiceRoleInstancesClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServiceRoleInstancesRestartPoller {
...
func (l *CloudServicesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesCreateOrUpdatePoller {
...
func (l *CloudServicesDeleteInstancesPollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.DeleteInstances", token, 	client.pl, client.deleteInstancesHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesDeleteInstancesPoller {
...
func (l *CloudServicesDeletePollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesDeletePoller {
...
func (l *CloudServicesPowerOffPollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.PowerOff", token, 	client.pl, client.powerOffHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesPowerOffPoller {
...
func (l *CloudServicesRebuildPollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Rebuild", token, 	client.pl, client.rebuildHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesRebuildPoller {
...
func (l *CloudServicesReimagePollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Reimage", token, 	client.pl, client.reimageHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesReimagePoller {
...
func (l *CloudServicesRestartPollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesRestartPoller {
...
func (l *CloudServicesStartPollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesStartPoller {
...
func (l *CloudServicesUpdateDomainWalkUpdateDomainPollerResponse) Resume(ctx context.Context, client *CloudServicesUpdateDomainClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesUpdateDomainClient.WalkUpdateDomain", token, 	client.pl, client.walkUpdateDomainHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesUpdateDomainWalkUpdateDomainPoller {
...
func (l *CloudServicesUpdatePollerResponse) Resume(ctx context.Context, client *CloudServicesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("CloudServicesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &CloudServicesUpdatePoller {
...
func (l *DedicatedHostsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DedicatedHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DedicatedHostsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DedicatedHostsCreateOrUpdatePoller {
...
func (l *DedicatedHostsDeletePollerResponse) Resume(ctx context.Context, client *DedicatedHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DedicatedHostsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DedicatedHostsDeletePoller {
...
func (l *DedicatedHostsUpdatePollerResponse) Resume(ctx context.Context, client *DedicatedHostsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DedicatedHostsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &DedicatedHostsUpdatePoller {
...
func (l *DiskAccessesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DiskAccessesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskAccessesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DiskAccessesCreateOrUpdatePoller {
...
func (l *DiskAccessesDeleteAPrivateEndpointConnectionPollerResponse) Resume(ctx context.Context, client *DiskAccessesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskAccessesClient.DeleteAPrivateEndpointConnection", token, 	client.pl, client.deleteAPrivateEndpointConnectionHandleError)
	if err != nil {
		return err
	}
	poller := &DiskAccessesDeleteAPrivateEndpointConnectionPoller {
...
func (l *DiskAccessesDeletePollerResponse) Resume(ctx context.Context, client *DiskAccessesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskAccessesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DiskAccessesDeletePoller {
...
func (l *DiskAccessesUpdateAPrivateEndpointConnectionPollerResponse) Resume(ctx context.Context, client *DiskAccessesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskAccessesClient.UpdateAPrivateEndpointConnection", token, 	client.pl, client.updateAPrivateEndpointConnectionHandleError)
	if err != nil {
		return err
	}
	poller := &DiskAccessesUpdateAPrivateEndpointConnectionPoller {
...
func (l *DiskAccessesUpdatePollerResponse) Resume(ctx context.Context, client *DiskAccessesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskAccessesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &DiskAccessesUpdatePoller {
...
func (l *DiskEncryptionSetsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DiskEncryptionSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskEncryptionSetsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DiskEncryptionSetsCreateOrUpdatePoller {
...
func (l *DiskEncryptionSetsDeletePollerResponse) Resume(ctx context.Context, client *DiskEncryptionSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskEncryptionSetsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DiskEncryptionSetsDeletePoller {
...
func (l *DiskEncryptionSetsUpdatePollerResponse) Resume(ctx context.Context, client *DiskEncryptionSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskEncryptionSetsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &DiskEncryptionSetsUpdatePoller {
...
func (l *DiskRestorePointGrantAccessPollerResponse) Resume(ctx context.Context, client *DiskRestorePointClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskRestorePointClient.GrantAccess", token, 	client.pl, client.grantAccessHandleError)
	if err != nil {
		return err
	}
	poller := &DiskRestorePointGrantAccessPoller {
...
func (l *DiskRestorePointRevokeAccessPollerResponse) Resume(ctx context.Context, client *DiskRestorePointClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DiskRestorePointClient.RevokeAccess", token, 	client.pl, client.revokeAccessHandleError)
	if err != nil {
		return err
	}
	poller := &DiskRestorePointRevokeAccessPoller {
...
func (l *DisksCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *DisksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DisksClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &DisksCreateOrUpdatePoller {
...
func (l *DisksDeletePollerResponse) Resume(ctx context.Context, client *DisksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DisksClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &DisksDeletePoller {
...
func (l *DisksGrantAccessPollerResponse) Resume(ctx context.Context, client *DisksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DisksClient.GrantAccess", token, 	client.pl, client.grantAccessHandleError)
	if err != nil {
		return err
	}
	poller := &DisksGrantAccessPoller {
...
func (l *DisksRevokeAccessPollerResponse) Resume(ctx context.Context, client *DisksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DisksClient.RevokeAccess", token, 	client.pl, client.revokeAccessHandleError)
	if err != nil {
		return err
	}
	poller := &DisksRevokeAccessPoller {
...
func (l *DisksUpdatePollerResponse) Resume(ctx context.Context, client *DisksClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("DisksClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &DisksUpdatePoller {
...
func (l *GalleriesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *GalleriesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleriesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleriesCreateOrUpdatePoller {
...
func (l *GalleriesDeletePollerResponse) Resume(ctx context.Context, client *GalleriesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleriesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &GalleriesDeletePoller {
...
func (l *GalleriesUpdatePollerResponse) Resume(ctx context.Context, client *GalleriesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleriesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleriesUpdatePoller {
...
func (l *GalleryApplicationVersionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *GalleryApplicationVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationVersionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationVersionsCreateOrUpdatePoller {
...
func (l *GalleryApplicationVersionsDeletePollerResponse) Resume(ctx context.Context, client *GalleryApplicationVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationVersionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationVersionsDeletePoller {
...
func (l *GalleryApplicationVersionsUpdatePollerResponse) Resume(ctx context.Context, client *GalleryApplicationVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationVersionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationVersionsUpdatePoller {
...
func (l *GalleryApplicationsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *GalleryApplicationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationsCreateOrUpdatePoller {
...
func (l *GalleryApplicationsDeletePollerResponse) Resume(ctx context.Context, client *GalleryApplicationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationsDeletePoller {
...
func (l *GalleryApplicationsUpdatePollerResponse) Resume(ctx context.Context, client *GalleryApplicationsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryApplicationsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryApplicationsUpdatePoller {
...
func (l *GalleryImageVersionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *GalleryImageVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImageVersionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImageVersionsCreateOrUpdatePoller {
...
func (l *GalleryImageVersionsDeletePollerResponse) Resume(ctx context.Context, client *GalleryImageVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImageVersionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImageVersionsDeletePoller {
...
func (l *GalleryImageVersionsUpdatePollerResponse) Resume(ctx context.Context, client *GalleryImageVersionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImageVersionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImageVersionsUpdatePoller {
...
func (l *GalleryImagesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *GalleryImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImagesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImagesCreateOrUpdatePoller {
...
func (l *GalleryImagesDeletePollerResponse) Resume(ctx context.Context, client *GalleryImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImagesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImagesDeletePoller {
...
func (l *GalleryImagesUpdatePollerResponse) Resume(ctx context.Context, client *GalleryImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GalleryImagesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GalleryImagesUpdatePoller {
...
func (l *GallerySharingProfileUpdatePollerResponse) Resume(ctx context.Context, client *GallerySharingProfileClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("GallerySharingProfileClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &GallerySharingProfileUpdatePoller {
...
func (l *ImagesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *ImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ImagesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &ImagesCreateOrUpdatePoller {
...
func (l *ImagesDeletePollerResponse) Resume(ctx context.Context, client *ImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ImagesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &ImagesDeletePoller {
...
func (l *ImagesUpdatePollerResponse) Resume(ctx context.Context, client *ImagesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("ImagesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &ImagesUpdatePoller {
...
func (l *LogAnalyticsExportRequestRateByIntervalPollerResponse) Resume(ctx context.Context, client *LogAnalyticsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LogAnalyticsClient.ExportRequestRateByInterval", token, 	client.pl, client.exportRequestRateByIntervalHandleError)
	if err != nil {
		return err
	}
	poller := &LogAnalyticsExportRequestRateByIntervalPoller {
...
func (l *LogAnalyticsExportThrottledRequestsPollerResponse) Resume(ctx context.Context, client *LogAnalyticsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("LogAnalyticsClient.ExportThrottledRequests", token, 	client.pl, client.exportThrottledRequestsHandleError)
	if err != nil {
		return err
	}
	poller := &LogAnalyticsExportThrottledRequestsPoller {
...
func (l *RestorePointCollectionsDeletePollerResponse) Resume(ctx context.Context, client *RestorePointCollectionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RestorePointCollectionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RestorePointCollectionsDeletePoller {
...
func (l *RestorePointsCreatePollerResponse) Resume(ctx context.Context, client *RestorePointsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RestorePointsClient.Create", token, 	client.pl, client.createHandleError)
	if err != nil {
		return err
	}
	poller := &RestorePointsCreatePoller {
...
func (l *RestorePointsDeletePollerResponse) Resume(ctx context.Context, client *RestorePointsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("RestorePointsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &RestorePointsDeletePoller {
...
func (l *SnapshotsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *SnapshotsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SnapshotsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &SnapshotsCreateOrUpdatePoller {
...
func (l *SnapshotsDeletePollerResponse) Resume(ctx context.Context, client *SnapshotsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SnapshotsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &SnapshotsDeletePoller {
...
func (l *SnapshotsGrantAccessPollerResponse) Resume(ctx context.Context, client *SnapshotsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SnapshotsClient.GrantAccess", token, 	client.pl, client.grantAccessHandleError)
	if err != nil {
		return err
	}
	poller := &SnapshotsGrantAccessPoller {
...
func (l *SnapshotsRevokeAccessPollerResponse) Resume(ctx context.Context, client *SnapshotsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SnapshotsClient.RevokeAccess", token, 	client.pl, client.revokeAccessHandleError)
	if err != nil {
		return err
	}
	poller := &SnapshotsRevokeAccessPoller {
...
func (l *SnapshotsUpdatePollerResponse) Resume(ctx context.Context, client *SnapshotsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("SnapshotsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &SnapshotsUpdatePoller {
...
func (l *VirtualMachineExtensionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineExtensionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineExtensionsCreateOrUpdatePoller {
...
func (l *VirtualMachineExtensionsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineExtensionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineExtensionsDeletePoller {
...
func (l *VirtualMachineExtensionsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineExtensionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineExtensionsUpdatePoller {
...
func (l *VirtualMachineRunCommandsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineRunCommandsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineRunCommandsCreateOrUpdatePoller {
...
func (l *VirtualMachineRunCommandsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineRunCommandsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineRunCommandsDeletePoller {
...
func (l *VirtualMachineRunCommandsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineRunCommandsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineRunCommandsUpdatePoller {
...
func (l *VirtualMachineScaleSetExtensionsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetExtensionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetExtensionsDeletePoller {
...
func (l *VirtualMachineScaleSetExtensionsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetExtensionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetExtensionsUpdatePoller {
...
func (l *VirtualMachineScaleSetRollingUpgradesCancelPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetRollingUpgradesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetRollingUpgradesClient.Cancel", token, 	client.pl, client.cancelHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetRollingUpgradesCancelPoller {
...
func (l *VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetRollingUpgradesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetRollingUpgradesClient.StartExtensionUpgrade", token, 	client.pl, client.startExtensionUpgradeHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetRollingUpgradesStartExtensionUpgradePoller {
...
func (l *VirtualMachineScaleSetRollingUpgradesStartOSUpgradePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetRollingUpgradesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetRollingUpgradesClient.StartOSUpgrade", token, 	client.pl, client.startOSUpgradeHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetRollingUpgradesStartOSUpgradePoller {
...
func (l *VirtualMachineScaleSetVMExtensionsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMExtensionsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMExtensionsCreateOrUpdatePoller {
...
func (l *VirtualMachineScaleSetVMExtensionsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMExtensionsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMExtensionsDeletePoller {
...
func (l *VirtualMachineScaleSetVMExtensionsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMExtensionsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMExtensionsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMExtensionsUpdatePoller {
...
func (l *VirtualMachineScaleSetVMRunCommandsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMRunCommandsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMRunCommandsCreateOrUpdatePoller {
...
func (l *VirtualMachineScaleSetVMRunCommandsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMRunCommandsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMRunCommandsDeletePoller {
...
func (l *VirtualMachineScaleSetVMRunCommandsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMRunCommandsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMRunCommandsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMRunCommandsUpdatePoller {
...
func (l *VirtualMachineScaleSetVMsDeallocatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Deallocate", token, 	client.pl, client.deallocateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsDeallocatePoller {
...
func (l *VirtualMachineScaleSetVMsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsDeletePoller {
...
func (l *VirtualMachineScaleSetVMsPerformMaintenancePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.PerformMaintenance", token, 	client.pl, client.performMaintenanceHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsPerformMaintenancePoller {
...
func (l *VirtualMachineScaleSetVMsPowerOffPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.PowerOff", token, 	client.pl, client.powerOffHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsPowerOffPoller {
...
func (l *VirtualMachineScaleSetVMsRedeployPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Redeploy", token, 	client.pl, client.redeployHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsRedeployPoller {
...
func (l *VirtualMachineScaleSetVMsReimageAllPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.ReimageAll", token, 	client.pl, client.reimageAllHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsReimageAllPoller {
...
func (l *VirtualMachineScaleSetVMsReimagePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Reimage", token, 	client.pl, client.reimageHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsReimagePoller {
...
func (l *VirtualMachineScaleSetVMsRestartPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsRestartPoller {
...
func (l *VirtualMachineScaleSetVMsRunCommandPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.RunCommand", token, 	client.pl, client.runCommandHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsRunCommandPoller {
...
func (l *VirtualMachineScaleSetVMsStartPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsStartPoller {
...
func (l *VirtualMachineScaleSetVMsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetVMsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetVMsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetVMsUpdatePoller {
...
func (l *VirtualMachineScaleSetsCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsCreateOrUpdatePoller {
...
func (l *VirtualMachineScaleSetsDeallocatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Deallocate", token, 	client.pl, client.deallocateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsDeallocatePoller {
...
func (l *VirtualMachineScaleSetsDeleteInstancesPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.DeleteInstances", token, 	client.pl, client.deleteInstancesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsDeleteInstancesPoller {
...
func (l *VirtualMachineScaleSetsDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsDeletePoller {
...
func (l *VirtualMachineScaleSetsPerformMaintenancePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.PerformMaintenance", token, 	client.pl, client.performMaintenanceHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsPerformMaintenancePoller {
...
func (l *VirtualMachineScaleSetsPowerOffPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.PowerOff", token, 	client.pl, client.powerOffHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsPowerOffPoller {
...
func (l *VirtualMachineScaleSetsRedeployPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Redeploy", token, 	client.pl, client.redeployHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsRedeployPoller {
...
func (l *VirtualMachineScaleSetsReimageAllPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.ReimageAll", token, 	client.pl, client.reimageAllHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsReimageAllPoller {
...
func (l *VirtualMachineScaleSetsReimagePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Reimage", token, 	client.pl, client.reimageHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsReimagePoller {
...
func (l *VirtualMachineScaleSetsRestartPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsRestartPoller {
...
func (l *VirtualMachineScaleSetsSetOrchestrationServiceStatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.SetOrchestrationServiceState", token, 	client.pl, client.setOrchestrationServiceStateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsSetOrchestrationServiceStatePoller {
...
func (l *VirtualMachineScaleSetsStartPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsStartPoller {
...
func (l *VirtualMachineScaleSetsUpdateInstancesPollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.UpdateInstances", token, 	client.pl, client.updateInstancesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsUpdateInstancesPoller {
...
func (l *VirtualMachineScaleSetsUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachineScaleSetsClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachineScaleSetsClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachineScaleSetsUpdatePoller {
...
func (l *VirtualMachinesAssessPatchesPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.AssessPatches", token, 	client.pl, client.assessPatchesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesAssessPatchesPoller {
...
func (l *VirtualMachinesCapturePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Capture", token, 	client.pl, client.captureHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesCapturePoller {
...
func (l *VirtualMachinesConvertToManagedDisksPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.ConvertToManagedDisks", token, 	client.pl, client.convertToManagedDisksHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesConvertToManagedDisksPoller {
...
func (l *VirtualMachinesCreateOrUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.CreateOrUpdate", token, 	client.pl, client.createOrUpdateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesCreateOrUpdatePoller {
...
func (l *VirtualMachinesDeallocatePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Deallocate", token, 	client.pl, client.deallocateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesDeallocatePoller {
...
func (l *VirtualMachinesDeletePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Delete", token, 	client.pl, client.deleteHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesDeletePoller {
...
func (l *VirtualMachinesInstallPatchesPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.InstallPatches", token, 	client.pl, client.installPatchesHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesInstallPatchesPoller {
...
func (l *VirtualMachinesPerformMaintenancePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.PerformMaintenance", token, 	client.pl, client.performMaintenanceHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesPerformMaintenancePoller {
...
func (l *VirtualMachinesPowerOffPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.PowerOff", token, 	client.pl, client.powerOffHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesPowerOffPoller {
...
func (l *VirtualMachinesReapplyPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Reapply", token, 	client.pl, client.reapplyHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesReapplyPoller {
...
func (l *VirtualMachinesRedeployPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Redeploy", token, 	client.pl, client.redeployHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesRedeployPoller {
...
func (l *VirtualMachinesReimagePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Reimage", token, 	client.pl, client.reimageHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesReimagePoller {
...
func (l *VirtualMachinesRestartPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Restart", token, 	client.pl, client.restartHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesRestartPoller {
...
func (l *VirtualMachinesRunCommandPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.RunCommand", token, 	client.pl, client.runCommandHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesRunCommandPoller {
...
func (l *VirtualMachinesStartPollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Start", token, 	client.pl, client.startHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesStartPoller {
...
func (l *VirtualMachinesUpdatePollerResponse) Resume(ctx context.Context, client *VirtualMachinesClient, token string) error {	pt, err := armruntime.NewPollerFromResumeToken("VirtualMachinesClient.Update", token, 	client.pl, client.updateHandleError)
	if err != nil {
		return err
	}
	poller := &VirtualMachinesUpdatePoller {
